        ...
        <div key={index} className='flex flex-col md:flex-row justify-between bg-primary/8
         border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
           <div className='flex flex-col md:flex-row'>
            <img src={item.show.movie.poster_path} alt='poster' className='md:max-w-45 aspect-video 
           ...
           md:text-righth justify-between p-4'>
              ...
              <div className='text-sm'>
                ...
                <p><span>Seat Numbere:</span>{item.bookedSeats.join(" ,")}</p>
              </div>
